...
check(is_writable(__DIR__.'/../phpbb/cache'), sprintf('Checking that phpbb/cache/ directory is writable'), 'Change the permissions of the phpbb/cache/ directory so that the web server can write in it', true);
check(is_writable(__DIR__.'/../phpbb/logs'), sprintf('Checking that the phpbb/logs/ directory is writable'), 'Change the permissions of the phpbb/logs/ directory so that the web server can write in it', true);
